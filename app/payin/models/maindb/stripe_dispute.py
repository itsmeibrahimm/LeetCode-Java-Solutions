...
class StripeDisputeTable(TableDefinition):
    ...
    disputed_at: Column = no_init_field(Column("disputed_at", DateTime(False)))
    ...
    charged_at: Column = no_init_field(Column("charged_at", DateTime(False)))
    reason: Column = no_init_field(Column("reason", Text))
    status: Column = no_init_field(Column("status", Text))
    evidence_due_by: Column = no_init_field(Column("evidence_due_by", DateTime(False)))
    evidence_submitted_at: Column = no_init_field(
        Column("evidence_submitted_at", DateTime(False))
    )
