...
from sqlalchemy import BigInteger, Column, DateTime, Integer, Text, Boolean, JSON
...
class CartPaymentTable(TableDefinition):
    ...
    reference_id: Column = no_init_field(Column("reference_id", Text))
    reference_type: Column = no_init_field(Column("reference_type", Text))
    ...
    client_description: Column = no_init_field(Column("client_description", Text))
