...
class TestCheckSMABalance:
    ...
    def setup(self):
        ...
        self.stripe_async_client.retrieve_balance = CoroutineMock()
    ...
    async def test_successfully_get_balance(self):
        ...
        self.stripe_async_client.retrieve_balance.return_value = stripe_balance
    ...
    async def test_should_raise_pgp_authentication_error(self):
        self.stripe_async_client.retrieve_balance.side_effect = PGPAuthenticationError
