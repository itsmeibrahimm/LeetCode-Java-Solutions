...
class GetDefaultPayoutCard(
    AsyncOperation[GetDefaultPayoutCardRequest, PayoutCardMethod]
):
    """
    ...
    async def _execute(self) -> PayoutCardMethod:
        ...
        payout_card_method: Optional[PayoutCardMethod] = None
        for payout_method in payout_methods:
            ...
            if payout_card and payout_method.is_default:
                payout_card_method = PayoutCardMethod(
    ...
    ) -> Union[PaymentException, PayoutCardMethod]:
